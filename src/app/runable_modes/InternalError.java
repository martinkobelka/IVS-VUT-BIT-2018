...
/**
 *
 * Runnable enviroment for internal error
 *
 * @author Martin Kobelka (xkobel02@stud.fit.vutbr.cz)
 * @version 1.0
 *
 */
public class InternalError extends HaveTranslator implements RunableMode {
    ...
    public void run(String[] args) {
        ...
        System.err.println(translator.translate("cli", "INTERNAL_ERROR"));
        System.exit(1);
